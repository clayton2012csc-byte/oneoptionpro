    ...
    <div className="px-3 pb-10 pt-4">
      ...
      {!q.isLoading && markets.length === 0 && (
        <p className="text-sm text-muted-foreground">
          Nenhum registro ainda. Rode <code>supabase/triagem.sql</code> no banco e aguarde a próxima
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
        {markets.map((m) => {
          ...
          return (
            <div key={m.market} className="glass rounded-2xl border border-white/10 overflow-hidden">
